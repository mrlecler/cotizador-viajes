    ...
    <div class="hist-item" onclick="loadFromHistory('${r.ref_id}','${r.id}')">
      ...
      <div style="display:flex;flex-direction:column;gap:6px;align-items:flex-end">
        ...
        <div style="display:flex;gap:4px;flex-wrap:wrap;justify-content:flex-end">
          ...
          ${(!r.estado||r.estado==='borrador')?`<button class="btn btn-del btn-xs" onclick="event.stopPropagation();deleteQuote('${r.id}')" title="Eliminar borrador"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg></button>`:''}
        </div>
      </div>
    </div>`).join('')+`
