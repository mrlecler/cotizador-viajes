...
async function renderHistory(){
  ...
  el.innerHTML=shown.map(r=>{
    ...
    const rsvBtn = (canE && (r.estado==='aprobado'||r.estado==='confirmada'))
      ? `<button class="btn btn-out btn-xs" onclick="event.stopPropagation();switchTab('seguimiento');setTimeout(()=>openSeguimientoDetail('${r.id}'),100)" style="color:#22c55e;border-color:rgba(34,197,94,0.3)"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M9 14l2 2 4-4"/></svg> Seguimiento</button>` : '';
